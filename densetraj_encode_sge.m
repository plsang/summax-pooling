function [ output_args ] = densetraj_encode_sge( proj_name, segment_ann, szPat, start_seg, end_seg )
	...
	feature_ext = sprintf('densetrajectory.mbh.cb%d.%s.segments%d', codebook_size, enc_type, segment_length);
	if dimred > 0,
